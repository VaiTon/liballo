...
- **Robust Verification**: Fully instrumented for ASan, UBSan, MSan, Valgrind, and AFL++ fuzzing.
...
`liballo` includes a high-entropy fuzzing harness that stress-tests every allocator implementation.

### AFL++ Fuzzing

We provide an automation script to simplify the AFL++ setup:
...
The fuzzer includes **data integrity verification** to catch overlapping allocations and memory corruption bugs.
